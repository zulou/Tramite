...
{% if documentos %}
    {% for document in documentos %}
        ...
        dataset.push({id:"{{document.id}}",doc_number:"{{document.doc_number}}",doc_exp_number:"{{document.doc_exp_number}}",id_type_document:"{{document.id_type_document.doc_des}}",doc_pages:"{{document.doc_pages}}",id_tupa:"{{document.id_tupa.tup_des}}",id_person:"{{document.id_person.per_name}}",doc_des:"{{document.id_tupa.id_ofi_end.ofi_des}}",id_type_origin:"{{document.doc_des.doc_type}}"});
        //console.log("{{vou}}");
